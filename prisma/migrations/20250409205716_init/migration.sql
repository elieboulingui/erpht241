...
-- CreateTable
CREATE TABLE "_ActivityLogToFavorite" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL,

    CONSTRAINT "_ActivityLogToFavorite_AB_pkey" PRIMARY KEY ("A","B")
);

-- CreateTable
CREATE TABLE "_ActivityLogToTask" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL,

    CONSTRAINT "_ActivityLogToTask_AB_pkey" PRIMARY KEY ("A","B")
);

-- CreateTable
CREATE TABLE "_ActivityLogToDevisItem" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL,

    CONSTRAINT "_ActivityLogToDevisItem_AB_pkey" PRIMARY KEY ("A","B")
);

-- CreateTable
CREATE TABLE "_ActivityLogToDevis" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL,

    CONSTRAINT "_ActivityLogToDevis_AB_pkey" PRIMARY KEY ("A","B")
);

-- CreateTable
CREATE TABLE "_ActivityLogToNote" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL,

    CONSTRAINT "_ActivityLogToNote_AB_pkey" PRIMARY KEY ("A","B")
);

-- CreateTable
CREATE TABLE "_ActivityLogToProduct" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL,

    CONSTRAINT "_ActivityLogToProduct_AB_pkey" PRIMARY KEY ("A","B")
);

-- CreateTable
CREATE TABLE "_ActivityLogToInvitation" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL,

    CONSTRAINT "_ActivityLogToInvitation_AB_pkey" PRIMARY KEY ("A","B")
);

-- CreateTable
CREATE TABLE "_ActivityLogToContact" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL,

    CONSTRAINT "_ActivityLogToContact_AB_pkey" PRIMARY KEY ("A","B")
);

-- CreateTable
CREATE TABLE "_ActivityLogToCategory" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL,

    CONSTRAINT "_ActivityLogToCategory_AB_pkey" PRIMARY KEY ("A","B")
);

-- CreateTable
CREATE TABLE "_ActivityLogToBrand" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL,

    CONSTRAINT "_ActivityLogToBrand_AB_pkey" PRIMARY KEY ("A","B")
);

-- CreateTable
CREATE TABLE "_ActivityLogToFeedbackContact" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL,

    CONSTRAINT "_ActivityLogToFeedbackContact_AB_pkey" PRIMARY KEY ("A","B")
);

-- CreateTable
CREATE TABLE "_ActivityLogToStock" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL,

    CONSTRAINT "_ActivityLogToStock_AB_pkey" PRIMARY KEY ("A","B")
);
...
-- CreateTable
CREATE TABLE "_ActivityLogToComment" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL,

    CONSTRAINT "_ActivityLogToComment_AB_pkey" PRIMARY KEY ("A","B")
);
...
-- CreateIndex
CREATE INDEX "_ActivityLogToFavorite_B_index" ON "_ActivityLogToFavorite"("B");

-- CreateIndex
CREATE INDEX "_ActivityLogToTask_B_index" ON "_ActivityLogToTask"("B");

-- CreateIndex
CREATE INDEX "_ActivityLogToDevisItem_B_index" ON "_ActivityLogToDevisItem"("B");

-- CreateIndex
CREATE INDEX "_ActivityLogToDevis_B_index" ON "_ActivityLogToDevis"("B");

-- CreateIndex
CREATE INDEX "_ActivityLogToNote_B_index" ON "_ActivityLogToNote"("B");

-- CreateIndex
CREATE INDEX "_ActivityLogToProduct_B_index" ON "_ActivityLogToProduct"("B");

-- CreateIndex
CREATE INDEX "_ActivityLogToInvitation_B_index" ON "_ActivityLogToInvitation"("B");

-- CreateIndex
CREATE INDEX "_ActivityLogToContact_B_index" ON "_ActivityLogToContact"("B");

-- CreateIndex
CREATE INDEX "_ActivityLogToCategory_B_index" ON "_ActivityLogToCategory"("B");

-- CreateIndex
CREATE INDEX "_ActivityLogToBrand_B_index" ON "_ActivityLogToBrand"("B");

-- CreateIndex
CREATE INDEX "_ActivityLogToFeedbackContact_B_index" ON "_ActivityLogToFeedbackContact"("B");

-- CreateIndex
CREATE INDEX "_ActivityLogToStock_B_index" ON "_ActivityLogToStock"("B");

-- CreateIndex
CREATE INDEX "_CreatedByUser_B_index" ON "_CreatedByUser"("B");

-- CreateIndex
CREATE INDEX "_ActivityLogToComment_B_index" ON "_ActivityLogToComment"("B");
...
-- AddForeignKey
ALTER TABLE "_ActivityLogToFavorite" ADD CONSTRAINT "_ActivityLogToFavorite_A_fkey" FOREIGN KEY ("A") REFERENCES "ActivityLog"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_ActivityLogToFavorite" ADD CONSTRAINT "_ActivityLogToFavorite_B_fkey" FOREIGN KEY ("B") REFERENCES "Favorite"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_ActivityLogToTask" ADD CONSTRAINT "_ActivityLogToTask_A_fkey" FOREIGN KEY ("A") REFERENCES "ActivityLog"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_ActivityLogToTask" ADD CONSTRAINT "_ActivityLogToTask_B_fkey" FOREIGN KEY ("B") REFERENCES "Task"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_ActivityLogToDevisItem" ADD CONSTRAINT "_ActivityLogToDevisItem_A_fkey" FOREIGN KEY ("A") REFERENCES "ActivityLog"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_ActivityLogToDevisItem" ADD CONSTRAINT "_ActivityLogToDevisItem_B_fkey" FOREIGN KEY ("B") REFERENCES "DevisItem"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_ActivityLogToDevis" ADD CONSTRAINT "_ActivityLogToDevis_A_fkey" FOREIGN KEY ("A") REFERENCES "ActivityLog"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_ActivityLogToDevis" ADD CONSTRAINT "_ActivityLogToDevis_B_fkey" FOREIGN KEY ("B") REFERENCES "Devis"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_ActivityLogToNote" ADD CONSTRAINT "_ActivityLogToNote_A_fkey" FOREIGN KEY ("A") REFERENCES "ActivityLog"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_ActivityLogToNote" ADD CONSTRAINT "_ActivityLogToNote_B_fkey" FOREIGN KEY ("B") REFERENCES "Note"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_ActivityLogToProduct" ADD CONSTRAINT "_ActivityLogToProduct_A_fkey" FOREIGN KEY ("A") REFERENCES "ActivityLog"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_ActivityLogToProduct" ADD CONSTRAINT "_ActivityLogToProduct_B_fkey" FOREIGN KEY ("B") REFERENCES "Product"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_ActivityLogToInvitation" ADD CONSTRAINT "_ActivityLogToInvitation_A_fkey" FOREIGN KEY ("A") REFERENCES "ActivityLog"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_ActivityLogToInvitation" ADD CONSTRAINT "_ActivityLogToInvitation_B_fkey" FOREIGN KEY ("B") REFERENCES "Invitation"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_ActivityLogToContact" ADD CONSTRAINT "_ActivityLogToContact_A_fkey" FOREIGN KEY ("A") REFERENCES "ActivityLog"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_ActivityLogToContact" ADD CONSTRAINT "_ActivityLogToContact_B_fkey" FOREIGN KEY ("B") REFERENCES "Contact"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_ActivityLogToCategory" ADD CONSTRAINT "_ActivityLogToCategory_A_fkey" FOREIGN KEY ("A") REFERENCES "ActivityLog"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_ActivityLogToCategory" ADD CONSTRAINT "_ActivityLogToCategory_B_fkey" FOREIGN KEY ("B") REFERENCES "Category"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_ActivityLogToBrand" ADD CONSTRAINT "_ActivityLogToBrand_A_fkey" FOREIGN KEY ("A") REFERENCES "ActivityLog"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_ActivityLogToBrand" ADD CONSTRAINT "_ActivityLogToBrand_B_fkey" FOREIGN KEY ("B") REFERENCES "Brand"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_ActivityLogToFeedbackContact" ADD CONSTRAINT "_ActivityLogToFeedbackContact_A_fkey" FOREIGN KEY ("A") REFERENCES "ActivityLog"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_ActivityLogToFeedbackContact" ADD CONSTRAINT "_ActivityLogToFeedbackContact_B_fkey" FOREIGN KEY ("B") REFERENCES "FeedbackContact"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_ActivityLogToStock" ADD CONSTRAINT "_ActivityLogToStock_A_fkey" FOREIGN KEY ("A") REFERENCES "ActivityLog"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_ActivityLogToStock" ADD CONSTRAINT "_ActivityLogToStock_B_fkey" FOREIGN KEY ("B") REFERENCES "Stock"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_CreatedByUser" ADD CONSTRAINT "_CreatedByUser_A_fkey" FOREIGN KEY ("A") REFERENCES "ActivityLog"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_CreatedByUser" ADD CONSTRAINT "_CreatedByUser_B_fkey" FOREIGN KEY ("B") REFERENCES "Product"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_ActivityLogToComment" ADD CONSTRAINT "_ActivityLogToComment_A_fkey" FOREIGN KEY ("A") REFERENCES "ActivityLog"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_ActivityLogToComment" ADD CONSTRAINT "_ActivityLogToComment_B_fkey" FOREIGN KEY ("B") REFERENCES "Comment"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_UpdatedByUser" ADD CONSTRAINT "_UpdatedByUser_A_fkey" FOREIGN KEY ("A") REFERENCES "ActivityLog"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_UpdatedByUser" ADD CONSTRAINT "_UpdatedByUser_B_fkey" FOREIGN KEY ("B") REFERENCES "Contact"("id") ON DELETE CASCADE ON UPDATE CASCADE;
