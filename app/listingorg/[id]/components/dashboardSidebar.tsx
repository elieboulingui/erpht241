...
import { getorganisation } from "../action/getorganisation" // Import the server-side function
...
import { NavSecondary } from "./nav-project"
...
const data = (orgId: string) => ({
  main: [
    ...
    { title: "produit", url: `/listingorg/${orgId}/produits`, icon: TbSettingsStar, isActive: false, items: [] },
  ],
  favorites: [
