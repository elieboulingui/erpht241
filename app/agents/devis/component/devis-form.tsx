...
export default function DevisForm({ initialData, onSave }: DevisFormProps) {
  ...
  const handleCancel = () => {
    ...
    toast.info("Formulaire annulé et réinitialisé", {
  ...
  const validateForm = () => {
    ...
    if (products.length === 0) {
      newErrors.products = "Au moins un produit est requis"
    }
        ...
        <table className="w-full border-collapse">
          <thead>
            <tr className="text-left text-sm">
              ...
              <th className="py-2 px-2">Quantité <span className="text-red-500">*</span></th>
              <th className="py-2 px-2">Prix <span className="text-red-500">*</span></th>
