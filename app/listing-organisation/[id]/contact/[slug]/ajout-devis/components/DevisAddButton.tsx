  ...
  return (
    <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DropdownMenuContent align="end" className="w-[175px]">
        <DropdownMenuItem
          onClick={() =>
            router.push(`/listing-organisation/${organisationId}/contact/${contactSlug}/ajout-devis-manuel`)
          }
        ...
        <DropdownMenuItem
          onClick={() => router.push(`/listing-organisation/${organisationId}/contact/${contactSlug}/ajout-devis-ia`)}
          className="cursor-pointer"
        >
