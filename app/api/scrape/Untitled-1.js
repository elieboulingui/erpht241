...
//     $("#listcol1").each((index, element) => {
//       const name = cleanText($(element).find("h3").text());
//       const service = cleanText($(element).find("span").text());
...
//       const email =
//         cleanText(webmailDiv.find("a[href^='mailto:']").text()) || "Non disponible";
//       const website =
//         cleanText(webmailDiv.find("a[href^='http']").attr("href")) || "Non disponible";

//       // Réseaux sociaux
//       const socialDiv = colRight.find("div.logos-restaurants");
//       const socialLinks: SocialMediaLinks = {};

//       socialDiv.find("a").each((i, link) => {
...
//     // Fallback si aucune entreprise trouvée
//     if (businesses.length === 0) {
//       $("div.col-right").each((index, element) => {
//         const parent = $(element).closest("#listcol1");
//         const name =
//           cleanText(parent.find("h3").text()) || `Entreprise ${index + 1}`;
//         const service = cleanText(parent.find("span").text());

//         // Adresse
//         const addressDiv = $(element).find("div.adresse");
//         let addressParts: string[] = [];
//         addressDiv.find("p").each((i, p) => {
//           const part = cleanText($(p).text());
//           if (part && part !== "Non disponible") {
...
//         // Téléphone
//         const telephoneDiv = $(element).find("div.telephone");
//         const fullPhoneInfo = cleanText(telephoneDiv.text());
//         const phoneNumbers: string[] = [];
...
//         // Email et site web
//         const webmailDiv = $(element).find("div.webmail");
//         const email =
//           cleanText(webmailDiv.find("a[href^='mailto:']").text()) || "Non disponible";
//         const website =
//           cleanText(webmailDiv.find("a[href^='http']").attr("href")) || "Non disponible";
...
//         // Réseaux sociaux
//         const socialDiv = $(element).find("div.logos-restaurants");
//         const socialLinks: SocialMediaLinks = {};
