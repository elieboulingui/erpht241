...
export default function PasswordResetConfirmation() {
  ...
  const handleResendRequest = async () => {
    ...
    try {
      ...
      if (response.ok) {
        setMessage("Un nouveau mail a été envoyé pour réinitialiser ton mot de passe.")
      } else {
        ...
        <div className="bg-white p-8 rounded-lg shadow-sm">
          ...
          <div className="bg-blue-50 p-4 rounded-lg mb-6 flex gap-3">
            ...
            <p className="text-sm text-gray-700">
              Si vous ne recevez pas de mail, veuillez vérifier que  email renseigné est correct. Aussi vérifiez
              les spams.
            </p>
          </div>
